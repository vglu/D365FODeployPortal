# ============================================================
# D365FO Deploy Portal — Linux Docker Image
# ============================================================
# NOTE: This image does NOT support 'pac package deploy' because
# that command is only available in the Windows MSI distribution
# of PAC CLI. Use Azure DevOps Release Pipelines for deployment.
# See: documents/Release-Pipeline-Universal-Package.md
#
...
# Run LCS->Unified conversion test to verify converter works in Linux container
...
# PAC: for conversion/auth. Azure CLI: for "Deploy via Release Pipeline" (Universal Package upload).
